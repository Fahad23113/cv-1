...
<head>
  ...
  <title>Fahad Alnogathier - CV</title>
...
<body>
  <div class="top-bar">Fahad Alnogathier</div>
  <div class="page">
    <div class="side-bar">
      <div class="mugshot">
        <svg viewBox="0 0 80 80" class="logo-svg">
          <path d="M 10 10 L 52 10 L 72 30 L 72 70 L 30 70 L 10 50 Z" stroke="black" stroke-width="2.5" fill="none"/>
        </svg>
        <p class="logo-text">FA</p>
      </div>
      <p>Riyadh, Saudi Arabia</p>
      <p>+966557906907</p>
      <p>z7ux12@gmail.com</p><br>
      <p><a href="https://linkedin.com/in/fahad-alnogaither-bab17a252" target="_blank">LinkedIn Profile</a></p>

      <p class="side-header">Expertise</p>
